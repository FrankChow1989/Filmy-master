...
public class BreathingProgress extends FrameLayout {
    ...
    private void createProgress(Context context) {
        ...
        LayoutParams layoutparams = new LayoutParams(widthPxForFixedRing, heightPxForFixedRing, Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL);
        ...
        LayoutParams layoutparamsBreathing = new LayoutParams(widthPxForBreathingCircle, heightPxForBreathingCircle, Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL);
